...
let RoleEntity = class RoleEntity extends sequelize_1.Model {
};
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.NUMBER, unique: true, autoIncrement: true }),
